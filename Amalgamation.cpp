...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
    ...
    // Bind skyline image to texture object texture[1]
...
//    glEnd();
    ...
    glTexCoord2f(0.0, 0.0); glVertex3f(-100.0, -100.0, 1);
    glTexCoord2f(1.0, 0.0); glVertex3f(100.0, -100.0, 1);
    glTexCoord2f(1.0, 1.0); glVertex3f(100.0, 100.0, 1);
    glTexCoord2f(0.0, 1.0); glVertex3f(-100.0, 100.0, 1);
    glEnd();
//    glBegin(GL_POLYGON);
//    glTexCoord2f(0.0, 0.0); glVertex3f(-1000.0, 150.0, -1000.0);
//    glTexCoord2f(1.0, 0.0); glVertex3f(1000.0, 150.0, -1000.0);
//    glTexCoord2f(1.0, 1.0); glVertex3f(1000.0, 1000.0, -1000.0);
//    glTexCoord2f(0.0, 1.0); glVertex3f(-1000.0, 1000.0, -1000.0);
//    glEnd();
//-------------------------//----------------------------/
...
//    gluPerspective(45.0, (GLfloat)window_width / (GLfloat) window_height, 0.1, 5000);
    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
